...
```mermaid
gantt
    title [고객사] 디지털 경남 — 특수강관 9 개월 압축 일정
    dateFormat  YYYY-MM
    axisFormat  %m/%y

    section 인프라
    데이터 통합·정형화 (OCR + 청킹)               :p1-1, 2026-05, 3M
    MLOps 최소 3 종 (레지스트리·모니터링·피드백)   :p1-2, 2026-06, 3M
    HITL 단일 통합 UI                              :p1-3, 2026-07, 3M

    section Phase 1 주력
    STL-08 Mill Sheet OCR — PoC·Pilot              :p1-4, 2026-06, 4M
    LLM-01 SOP RAG — PoC·Pilot                     :p1-5, 2026-06, 4M
    STL-07 공정설계 LLM — PoC                      :p1-6, 2026-08, 2M

    section Phase 2 운영·정리
    STL-07 공정설계 LLM — Pilot + 베테랑 검수      :p2-1, 2026-10, 2M
    STL-11 UT 자동판정 — PoC·Pilot                 :p2-2, 2026-10, 2M
    챔피언 검증 + 후속 로드맵                      :p2-3, 2026-12, 1M
```
