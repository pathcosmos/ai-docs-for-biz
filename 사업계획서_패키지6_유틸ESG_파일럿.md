...
flowchart TB
    subgraph 데이터수집[데이터 수집]
        D1[FEMS<br/>전력·LNG·증기]
        D2[보일러·컴프레서 PLC<br/>압력·유량·전력]
        D3[TMS·CEMS<br/>수질·대기]
        D4[CCTV 비전<br/>보호구·위험구역]
        D5[웨어러블·출입 태그<br/>심박·가스]
        D6[MSDS·PTW·사고이력<br/>비정형 문서]
        D7[밀시트·배출계수<br/>제품 단위 산정용]
    end
    D1 & D2 --> P1[5.2-e 에너지 최적화·제어<br/>UTL-01]
    D2 --> P2[5.2-d 예지보전<br/>UTL-02]
    D3 --> P3[5.2-b 환경 이상 예측<br/>UTL-03]
    D4 & D5 --> P4[5.2-c 안전 비전·IoT<br/>SAF-01]
    D6 --> P5[5.2-f MSDS RAG<br/>옵션 LLM-04]
    D1 & D7 --> P6[5.2-b·e CBAM 산정<br/>SAF-02]
    P1 & P2 & P3 & P4 & P5 & P6 --> EB[이벤트 버스·통합 대시보드]
    EB --> ESC[알람 에스컬레이션 엔진<br/>현장→관리→책임자→경영]
    EB --> RPT[외부 보고 체계 자동 생성<br/>CBAM 분기·TMS·KOSHA·ESG]
```
...
```mermaid
gantt
    title [고객사] 유틸·ESG 12 개월 사업 일정
    dateFormat  YYYY-MM
    section Phase 1 (M1~M3)
    데이터 수집 인프라 + 거버넌스          :p1, 2026-05, 3M
    BLK-CBAM-A·B·C·D 본문 정합 검토        :p1b, 2026-05, 2M
    BLK-SAF-A·B·C·D 본문 정합 검토         :p1c, 2026-05, 2M
    section Phase 2 (M4~M9)
    UTL-01 5.2-e 에너지 최적화 1 차 도입    :p2a, 2026-08, 3M
    UTL-02 5.2-d 예지보전 1 차 도입         :p2b, 2026-08, 3M
    UTL-03 5.2-b 환경 예측 1 차 도입         :p2c, 2026-09, 3M
    SAF-01 5.2-c 안전 비전 1 차 도입         :p2d, 2026-09, 4M
    SAF-02 5.2-b·e CBAM 산정·보고 1 차 도입 :p2e, 2026-10, 4M
    section Phase 3 (M10~M12)
    M9 게이트 → 클로즈드루프 단계 확장 검증  :p3a, 2027-02, 2M
    MLOps 풀 7 종 통합 + 챔피언·챌린저 검증 :p3b, 2027-02, 2M
    외부 검증 (CBAM·KOSHA·CSAP) 대응        :p3c, 2027-03, 2M
```
