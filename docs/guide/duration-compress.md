...
```mermaid
gantt
    title [고객사] 6 개월 압축 사업 — SaaS 경량 모드
    dateFormat  YYYY-MM
    axisFormat  %m/%y

    section 인프라 (최소화)
    데이터 통합·SaaS 적재                  :p1-1, 2026-05, 2M
    MLOps 최소 (모니터링·피드백 2 종)       :p1-2, 2026-06, 2M
    HITL 단일 통합 UI                       :p1-3, 2026-06, 2M

    section Phase 1 (1~3M) 주력 PoC
    [시나리오 A] PoC                        :p1-4, 2026-05, 3M

    section Phase 2 (4~6M) Pilot+정리
    [시나리오 A] Pilot                      :p2-1, 2026-08, 2M
    [시나리오 B] 경량 PoC (옵션)             :p2-2, 2026-08, 2M
