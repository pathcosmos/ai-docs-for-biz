...
## 10. 다년 R&D 외부 컨설팅 + 위탁 분산 보강 (Phase E7 — 갭 #10·#11·#14)

> Phase E7 (#33) 신규 갭 #10 (외부 컨설팅 차원) + #11 (다년 참여 차수) + #14 (위탁 분산) 보강. 본 §10 은 단년 R&D 의 단일 주관기관 + 단일 위탁 표준에 다년 R&D 의 외부 컨설팅 + 다 위탁 분산 + 다년 참여 차수의 3 차원을 추가한다.

### 10.1 추진체계도 외부 컨설팅 차원 (갭 #10)

다년 R&D 양식의 추진체계도는 단년 R&D 의 「주관기관 + 전문기관 + (선택) 위탁기관」 3 행 표준에 **외부 컨설팅 행** 을 추가한다. 1단계 컨설팅 본체 패턴 (가이드_컨설팅_위탁_운영.md §4 강도 3 단계) 을 추진체계도에 명시.
...
2단계 2년차 등에서 6 종 이상 동시 위탁 (PLC·통합관제·PPL/WSL/CRM/SSL 모니터링 등) 진행 시 위탁 분산 매트릭스 표가 필요하다. 위탁 분산은 단일 위탁기관의 결과 미달 위험 (가이드_위험관리_매트릭스.md §5 카테고리 5) 분산 효과 + 도메인별 전문성 활용 효과의 양면.
...
> [출처: 양식검증_DX촉진_R&D.md §7 갭 #10·#11·#14 + 사업계획서_패키지1_대기업철강_파일럿.md §5.3·§6.2.3·§6.3 + 가이드_컨설팅_위탁_운영.md §4 (Phase E7 신설) + 가이드_위험관리_매트릭스.md §5 카테고리 5 (Phase E7 신설) + 방법론_총론.md §3.32 단계+연차 이중 구조]
